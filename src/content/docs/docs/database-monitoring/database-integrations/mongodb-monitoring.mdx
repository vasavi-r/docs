...
![The MongoDB dashboard, with server uptime, database and collection counts, cache hit rate, and operation, memory, and query rate charts](./images/mongodb-dashboard.png)
